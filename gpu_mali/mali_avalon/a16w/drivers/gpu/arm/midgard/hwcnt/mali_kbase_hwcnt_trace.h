...
TRACE_EVENT(hwcnt_client_dump, TP_PROTO(u64 ts, u64 dump_ts, bool dump), TP_ARGS(ts, dump_ts, dump),
	    TP_STRUCT__entry(__field(u64, ts) __field(u64, dump_ts) __field(bool, dump)),
