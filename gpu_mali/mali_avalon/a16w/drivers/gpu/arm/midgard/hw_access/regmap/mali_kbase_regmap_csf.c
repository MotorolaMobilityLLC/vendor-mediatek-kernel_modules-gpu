...
static void kbase_regmap_v14_8_init(struct kbase_device *kbdev)
{
	...
	kbdev->regmap.flags[GPU_CONTROL__MCU_CORE_MASK] =
...
#if IS_ENABLED(CONFIG_MALI_MTK_CORE_MASK_SET)
	kbdev->regmap.regs[GPU_CONTROL__MCU_CORE_MASK] = kbdev->reg + 0x30a0;
#endif
...
#if IS_ENABLED(CONFIG_MALI_MTK_CORE_MASK_SET)
	[GPU_CONTROL__MCU_CORE_MASK] = "GPU_CONTROL__MCU_CORE_MASK",
#endif
